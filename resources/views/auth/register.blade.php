    ...
    <div class="hero">
        ...
        <div class="form-box">
            <div class="button-box">
                ...
                <div id="btn"> </div>
                <button type="button" class="toggle-btn" >Registration</button>
            ...
            {{-- User Login Form  --}}
            <form id="login" action="{{ route ('register')}}" class="inp-group" method="POST" enctype="multipart/form-data">
                @csrf
                {{-- <input type="file" class="inp  @error('image') is-invalid @enderror"  name="image" placeholder="Username" value="{{ old('image') }}">
                @error('image')
